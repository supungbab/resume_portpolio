        ...
        <div class="about">
            <div class="intro">
                ...
                <div class="card_title">
                    <p>안녕하세요.<br>신입 웹 프론트엔드 개발자 경명호 입니다.</p>
                </div>
                <div class="card_content">
                    <p>
                        안녕하세요. 신입 웹 프론트엔드 개발자 경명호 입니다.</br>
                        Vanilla JS 를 이용한 웹 페이지를 만들어 보았습니다.</br>
                        JS 를 이용해 컴포넌트를 나눈 후<br>
                        React 와 비슷한 구조로 작성된 웹 페이지 입니다.</br>
                        아직은 부족한 점이 많지만 더욱 더 발전 하고 싶습니다.
                    </p>
                </div>
                <div class="profile">
